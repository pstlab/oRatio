...
namespace ac {
    ...
    class and_propagator : public propagator {
        friend class network;
    public:
        and_propagator(and_propagator&&) = delete;
        virtual ~and_propagator();
    ...
    private:
        ...
        and_propagator(network * const net, const std::vector<bool_var*> vars);
