...
namespace smt
{
    ...
    SMT_EXPORT rdl_theory::rdl_theory(sat_core &sat, const rdl_theory &orig) : theory(sat), n_vars(orig.n_vars), _dists(orig._dists), _preds(orig._preds), layers(orig.layers), listening(orig.listening)
    {
