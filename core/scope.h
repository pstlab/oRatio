...
namespace ratio
{
  ...
  public:
    ...
    inline virtual core &get_core() const { return cr; } // returns the core in which this scope is defined..
    ...
    CORE_EXPORT virtual const std::map<std::string, predicate *> &get_predicates() const noexcept; // returns a map of predicates defined within this scope having the predicates' names as keys..
