...
solver_listener::flaw_listener::flaw_listener(solver_listener &listener, const flaw &f) : sat_value_listener(listener.slv.sat_cr), listener(listener), f(f) { listen_sat(f.get_phi()); }
...
solver_listener::resolver_listener::resolver_listener(solver_listener &listener, const resolver &r) : sat_value_listener(listener.slv.sat_cr), listener(listener), r(r) { listen_sat(r.get_rho()); }
