...
namespace ratio
{
    ...
    reusable_resource::order_resolver::order_resolver(rr_flaw &flw, const lit &r, const atom &before, const atom &after) : resolver(flw.get_graph(), r, 0, flw), before(before), after(after) {}
