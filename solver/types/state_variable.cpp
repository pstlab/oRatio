...
namespace ratio
{
    ...
    state_variable::place_resolver::place_resolver(sv_flaw &flw, const lit &r, atom &plc_atm, item &plc_itm, atom &frbd_atm) : resolver(flw.get_graph(), r, 0, flw), plc_atm(plc_atm), plc_itm(plc_itm), frbd_atm(frbd_atm) {}
